...
SECRET_KEY = 'k%yup892b=a6=ephwgaz1%z9(zia&#v21j^@4xoo)lwjz&n__9'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'octopus', 'ui', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(BASE_DIR, 'octopus', 'ui', 'static')
