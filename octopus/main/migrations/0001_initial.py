# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-11-01 12:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_face_value', models.IntegerField(default=20, verbose_name='总面值/分')),
                ('period', models.DateField(verbose_name='发行年代')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_key', models.BooleanField(default=False, verbose_name='是否筋票')),
                ('p', models.FloatField(verbose_name='齿孔')),
                ('top_size', models.FloatField(verbose_name='上边距')),
                ('right_size', models.FloatField(verbose_name='右边距')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='main.StampGroupCatalog')),
            ],
            options={
